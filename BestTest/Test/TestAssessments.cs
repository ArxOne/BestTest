...
namespace BestTest.Test
{
    ...
    public class TestAssessments
    {
        ...
        public IList<TestResult> Assessments { get; }
        public TestResultCode ResultCode => Assessments.Last().ResultCode;
        public TestResult TestStepResult => Assessments.SingleOrDefault(a => a.Step == TestStep.Test);
        ...
        public TestAssessments(TestDescription description, IEnumerable<TestResult> assessments)
        {
